...
class _EpisodesSearchScreenState extends State<EpisodesSearchScreen> {
  ...
  Card _info(FeedPodcast podcast) {
    ...
    return Card(
      elevation: 2.0, // Adjust elevation for shadow intensity
      margin: const EdgeInsets.symmetric(horizontal: 8.0, vertical: 8.0), // Add margins if needed outside the card
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 8), // Padding inside the card
        child: Column(
          children: [
            Row(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(imageUrl: _selectedEpisode == null ? podcast.imageUrl : _selectedEpisode?.imageUrl ?? "", placeholder: (context, url) => const SizedBox(width: 50, height: 50, child: Center(child: CircularProgressIndicator())), errorWidget: (context, url, error) => const Icon(Icons.broken_image_outlined, size: 50)),
                  ),
                ),
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (false && _selectedEpisode != null) SimpleAudioPlayer(url: _selectedEpisode!.mediaUrl),
                    ],
                  ),
                ),
              ],
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text(episode.pubDate, style: TextStyle(color: Colors.grey.shade600)),
                      onTap: () async {
                        setState(() {
